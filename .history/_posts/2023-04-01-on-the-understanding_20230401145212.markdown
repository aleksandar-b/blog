...
Shortly, Understanding is a knowledge of cause and effect taken directly from perception. Actually Understanding creates our Perception from raw senses. It has it's own "software" that consists of 3 components - Time, Space and Causality.
