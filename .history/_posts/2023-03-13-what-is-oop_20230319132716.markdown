...
Those 3 things can not exist without each other. Entities require existence so they can live. But to live is to Change is only possible in existence or in time. 