...
Shortly, Understanding is a knowledge of cause and effect taken directly from perception. Actually Understanding creates our Perception from raw senses by transforming them in search for an external object in Space as a cause. It has it's own with it's own "software" and his 3 components - Time, Space and Causality. There is also an indirect understading where we create causal connection between distant objects.
